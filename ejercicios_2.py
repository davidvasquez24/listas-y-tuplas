...
texto.count('a')
print("EN EL TEXTO LA LETRA 'a' aparece repetida",texto.count('a'),"veces")
...
frase = "Me gusta Java"
print("Me gusta Java".replace("Java","Python"))
...
palabras = oracion.split() # split divide la cadena en una lista de palabras 
print(len(palabras))

# 10. Convertir la cadena a formato título → "El Señor De Los Anillos"
libro = "el señor de los anillos"
print(libro.title()) #.title() cambia a formato titulo 
# 11. Quitar los espacios en blanco al inicio y al final del saludo
saludo = "   Hola mundo   "
print(saludo.strip()) #.strip() quita los espacios al inicio y final de una cadena devolviendo el resultado sin espacios 
# 12. Verificar si la cadena contiene solo letras (sin números ni símbolos)
codigo = "Python3"
print(codigo.isalpha()) #.isalpha () determina si es verdadero o falso, lo cual "true" significa que la cadena solo tiene caracteres en letras y false si tambien incluye numeros 
if codigo.isalpha() : True (print ("la cadena solo tiene caracteres alfabeticos"))
else :(print("la cadena tiene tambien caracteres numericos"))
...
nombre = "Luis"
apellido = "Martínez"
print("su nombre de usuario es:", (nombre[0:2]+apellido[5:8]))
